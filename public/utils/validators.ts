...
const PLAYLIST_MIL = 4;
const PLAYLIST_MIL_MES = 'Название плейлиста должно содержать от 4 символов'
const PLAYLIST_MAL = 20;
const PLAYLIST_MAL_MES = 'Название плейлиста должно содержать не более 20 символов'
const PLAYLIST_SYM = 'a-zA-Z0-9_';
const PLAYLIST_SYM_MES = 'Название плейлиста может содержать только латинские буквы, цифры и символы подчеркивания'
